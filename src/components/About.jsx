...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gray-900 w-full overflow-hidden">
      <div className="mx-auto w-full max-w-7xl px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center w-full">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="lg:w-1/3 flex justify-center w-full"
          >
            <div className="relative group w-full max-w-xs">
              ...
              <img 
                ...
                alt="Profile" 
                className="relative z-10 w-full h-auto aspect-square object-cover rounded-2xl border-2 border-gray-700 group-hover:border-transparent transition-all"
              />
            </div>
          </motion.div>
          ...
          >
            ...
            {/* Skills Grid */}
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10 w-full">
              {skills.map((skill, index) => (
                <motion.div
                  key={index}
                  whileHover={{ y: -5 }}
                  className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-cyan-400/30 transition-all w-full"
                >
